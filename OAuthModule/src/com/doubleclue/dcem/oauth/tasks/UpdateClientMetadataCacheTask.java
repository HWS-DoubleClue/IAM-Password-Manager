package com.doubleclue.dcem.oauth.tasks;
...
public class UpdateClientMetadataCacheTask implements Runnable, Serializable {
	...
	public UpdateClientMetadataCacheTask(String clientId, String tenantName) {
		super();
	...
	public void run() {
		...
		try {
			...
			OAuthLogic oauthLogic = CdiUtils.getReference(OAuthLogic.class);
			...
			oauthLogic.invalidateMetadata(clientId);
		} catch (Throwable t) {
