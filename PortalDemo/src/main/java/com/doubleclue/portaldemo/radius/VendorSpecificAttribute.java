...
public class VendorSpecificAttribute extends RadiusAttribute {
	 ...
	 * @see com.doubleclue.portaldemo.radius.RadiusAttribute#setDictionary(com.doubleclue.portaldemo.radius.tinyradius.dictionary.Dictionary)
	 */
	 ...
	 * @see com.doubleclue.portaldemo.radius.RadiusAttribute#writeAttribute()
	 */
	 ...
	 * structure.
	 * @see com.doubleclue.portaldemo.radius.RadiusAttribute#readAttribute(byte[], int,
	 * int)
	 */
	 ...
	 * @see com.doubleclue.portaldemo.radius.RadiusAttribute#toString()
	 */
