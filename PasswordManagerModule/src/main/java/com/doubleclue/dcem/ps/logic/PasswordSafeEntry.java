...
public class PasswordSafeEntry {
	...
	public void setTitle(String title) {
		setValue(false, PmConstants.KEEPASS_PROPERTY_TITLE, title);
	}
	...
	public void setPassword(String password) {
		setValue(true, PmConstants.KEEPASS_PROPERTY_PASSWORD, password);
	}
	...
	public void setUrl(String url) {
		setValue(false, PmConstants.KEEPASS_PROPERTY_URL, url);
	}

	public String getUrlShort() {
		if (this.getUrl() != null && this.getUrl().length() > PmConstants.PASSOWRD_SAFE_MAX_FIELD_LENGTH) {
			return this.getUrl().substring(0, PmConstants.PASSOWRD_SAFE_MAX_FIELD_LENGTH) + "...";
		}
		return this.getUrl();
	}
	...
	public void setNotes(String notes) {
		setValue(false, PmConstants.KEEPASS_PROPERTY_NOTES, notes);
	}

	public String getNotesShort() {
		if (this.getNotes().length() > PmConstants.PASSOWRD_SAFE_MAX_FIELD_LENGTH) {
			return this.getNotes().substring(0, PmConstants.PASSOWRD_SAFE_MAX_FIELD_LENGTH) + "...";
		}
	...
	public void setUsername(String username) {
		setValue(false, PmConstants.KEEPASS_PROPERTY_USER_NAME, username);
	}
