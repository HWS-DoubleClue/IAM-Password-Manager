...
import com.doubleclue.dcem.ps.gui.PasswordSafeRecentFile;
...
public class KeePassLogic {
	...
	private Logger logger = LogManager.getLogger(KeePassLogic.class);
	...
	public byte[] saveDatabaseFile(CloudSafeEntity cloudSafeEntity, KeePassFile _keePassFile, String fileName, String _password) throws DcemException {
		...
		cloudSafeLogic.setCloudSafeByteArray(cloudSafeEntity, null, byteArrayOutputStream.toByteArray(), operatorSessionBean.getDcemUser(), null);
