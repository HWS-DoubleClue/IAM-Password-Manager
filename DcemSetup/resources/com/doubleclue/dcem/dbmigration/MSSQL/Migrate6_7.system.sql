...
ALTER TABLE as_cloudsafe ADD dc_is_folder BIT DEFAULT 0 NOT NULL;
...
ALTER TABLE as_cloudsafe ADD lastModifiedUser_dc_id INTEGER;
...
create table core_alert_message (
	dc_id int not null,
	dc_alert_category int not null,
	dc_alert_severity int not null,
	dc_closed datetime2,
	dc_alert_error_code int,
