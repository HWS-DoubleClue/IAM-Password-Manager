...
@ApplicationScoped
@Named("RadiusTestWoChallenge")
public class RadiusTestWoChallenge extends AbstractTestUnit {
	...
	public String start() throws Exception {
		...
		ar.addAttribute("NAS-IP-Address", "192.168.2.41");
