...
//            System.out.println("BinaryEnricher.enrichEntriesWithBinaryData() " + entry.getTitle());
            for (Attachment attachment : entry.getAttachments()) {
//            	System.out.println("BinaryEnricher.enrichEntriesWithBinaryData() attachment: " + attachment.getKey());
