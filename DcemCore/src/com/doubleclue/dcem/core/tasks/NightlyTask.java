...
public class NightlyTask extends CoreTask {

	private static final Logger logger = LogManager.getLogger(NightlyTask.class);

	CountDownLatch countDownLatch;

	public NightlyTask() {
		super(NightlyTask.class.getSimpleName(), null);
	}
