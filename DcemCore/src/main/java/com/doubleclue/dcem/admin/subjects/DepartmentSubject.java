...
public class DepartmentSubject extends SubjectAbs{
	...
	public  DepartmentSubject () {
		...
		RawAction rawAction = new RawAction (DcemConstants.ACTION_ORGANIGRAM, new String []  {DcemConstants.SYSTEM_ROLE_SUPERADMIN, DcemConstants.SYSTEM_ROLE_ADMIN}, ActionSelection.ONE_ONLY);
