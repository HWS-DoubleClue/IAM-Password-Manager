...
public class LoginWebFilter extends DcemFilter {
	...
	private static final String DM_DOWNLOAD_SERVLET_URL = DcemConstants.WEB_MGT_CONTEXT + "/" + DcemConstants.DM_DOWNLOAD_SERVLET_PATH;
	...
	//	allowedPaths.add(DM_DOWNLOAD_SERVLET_URL);
