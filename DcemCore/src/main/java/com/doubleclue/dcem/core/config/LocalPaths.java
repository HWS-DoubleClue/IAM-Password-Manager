...
public class LocalPaths {
	...
	public static File getDcemInstallDir() throws DcemException {
		...
		try {
			...
			System.out.println("LocalPaths.getDcemInstallDir() Path Location: " + filePath.getPath());
		...
		//		dcemInstallDir = FileSystems.getDefault().getPath("");
				dcemInstallDir = new File (FileSystems.getDefault().getPath("").toUri());
			}
