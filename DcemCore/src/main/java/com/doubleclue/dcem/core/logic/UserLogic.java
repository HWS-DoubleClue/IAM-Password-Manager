...
public class UserLogic {
	...
	@DcemTransactional
	public DcemUser addOrUpdateUser(DcemUser user, DcemAction dcemAction, boolean withAudit, boolean numericPassword, int passwordLength, boolean savePassword)
	...
	public List<DcemUser> getCompleteDcemUser(String name, int max) {
