...
public enum DcemErrorCodes {
	...
	OPTIMISTIC_LOCK, LDAP_NAME_NOT_FOUND, VALIDATION_CONSTRAIN_VIOLATION, UNABLE_TO_UPLOAD_FILE, INVALID_FILE_FORMAT, INVALID_KEEPASS_ALGORITHM, PAGE_NOT_FOUND, OCR_TESSERACT_NOT_CONFIGURED, OCR_TESSERACT_ERROR;
