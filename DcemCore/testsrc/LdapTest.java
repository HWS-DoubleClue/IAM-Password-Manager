...
public class LdapTest {
	...
	public static void main(String[] args) throws NamingException {
		...
		final String ldapAdServer = "ldap://hws001s0004.dom1.ad.tld:389";
	...
	static public Map<String, Attributes> findAccountByAccountName(DirContext ctx, String ldapSearchBase, String accountName)
		...
		String returnedAtts[] = { "distinguishedName", "mail", "givenName",
				"sn", "telephone", "mobile", "sAMAccountName" };
	...
	static public Map<String, Attributes> findGroups(DirContext ctx, String ldapSearchBase, String accountName)
			throws NamingException {
