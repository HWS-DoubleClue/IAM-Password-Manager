...
dc_length number(10,0),
dc_name varchar2(255 char) not null,
options varchar2(255 char),
owner number(10,0),
sign number(1,0) not null,
dc_signature long raw,
dc_content blob,
...
dc_id number(10,0) not null,
writeAccess number(1,0) not null,
cloudData_dc_id number(10,0),
...
udid raw(255),
asVersion_dc_id number(10,0) not null,
userId number(10,0) not null,
primary key (dc_id)
);
