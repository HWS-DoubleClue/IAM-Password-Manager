...
public class TestEntityLogic {
	...
	private Logger logger = LogManager.getLogger(TestEntityLogic.class);
	...
	@DcemTransactional
	public void addOrUpdate (TestEntity testEntity, DcemAction dcemAction) throws DcemException {
		if (dcemAction.getAction().equals(DcemConstants.ACTION_ADD)) {
			em.persist(testEntity);
		} else {			
			em.merge(testEntity);
		}
		auditingLogic.addAudit(dcemAction, testEntity.toString());
	}
