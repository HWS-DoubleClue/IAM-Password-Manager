...
public class DeviceApiServiceImpl {
	...
	public Response fidoStartRegistration(String userId, String rpId, SecurityContext securityContext) {
		try {
			DcemUser dcemUser = userLogic.getUser(Integer.getInteger(userId));
