...
public class RadiusAttribute {
	...
	public void setAttributeValue(String value) {
		this.attributeData = value.getBytes(StandardCharsets.UTF_8);
	}
	 ...
	 */
	public String getAttributeValueHex() {
		return StringUtils.getHexString(getAttributeData());
	}
	
	public String getAttributeValueString() {
		return new String (this.attributeData, StandardCharsets.UTF_8);
	}
	...
	public String toString() {
		...
		return attributeType + ":" + name + ": " + getAttributeValueHex() + " - " + new String(getAttributeData());
	}
