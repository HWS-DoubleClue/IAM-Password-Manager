...
import com.doubleclue.dcem.radius.dictionary.Dictionary;
...
public class VendorSpecificAttribute extends RadiusAttribute {
	 ...
	 * @see com.doubleclue.dcem.radius.attribute.RadiusAttribute#setDictionary(org.tinyradius.dictionary.Dictionary)
	 */
	 ...
	 */
	public String getSubAttributeValueHex(String type) throws RadiusException {
		RadiusAttribute attr = getSubAttribute(type);
		if (attr == null)
			return null;
		else
			return attr.getAttributeValueHex();
	}

	/**
	 * Renders this attribute as a byte array.
	 * @see com.doubleclue.dcem.radius.attribute.RadiusAttribute#writeAttribute()
	 */
	 ...
	 * structure.
	 * @see com.doubleclue.dcem.radius.attribute.RadiusAttribute#readAttribute(byte[], int,
	 * int)
	 */
	 ...
	 * @see com.doubleclue.dcem.radius.attribute.RadiusAttribute#toString()
	 */
